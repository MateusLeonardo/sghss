...
Bem-vindo ao **Sistema de Gestão de Consultas Médicas**! Este é um sistema desenvolvido utilizando **NestJS** e **Prisma** que visa simplificar o agendamento de consultas médicas e a gestão de registros médicos. Ele foi desenvolvido para ser robusto e escalável, oferecendo uma interface de backend bem estruturada para o gerenciamento de usuários (pacientes, médicos, atendentes e administradores).
...
1. **GET /users**
   ...
   - **Uso**: Permite que o administrador consulte todos os usuários do sistema.
